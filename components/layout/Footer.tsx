...
const SOCIAL_LINKS = [
    {
        label: "Instagram",
        href: "https://instagram.com/mgrtechno",
        icon: (
            <svg
    ...
    {
        label: "Facebook",
        href: "https://facebook.com/mgrtechno",
        icon: (
            <svg
                xmlns="http://www.w3.org/2000/svg"
                className="w-5 h-5"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <p className="text-sm text-gray-400 leading-relaxed">
                            Tu tienda de tecnología en Rosario. Componentes,
                            periféricos y más con la mejor atención.
                        </p>
                        ...
                        <div className="flex items-center gap-3 mt-2">
                            {SOCIAL_LINKS.map((social) => (
                                <a
                                    ...
                                    className="w-9 h-9 rounded-lg bg-gray-800 hover:bg-brand flex items-center justify-center text-gray-400 hover:text-white transition-colors"
                                >
                                    {social.icon}
                                </a>
                            ))}
